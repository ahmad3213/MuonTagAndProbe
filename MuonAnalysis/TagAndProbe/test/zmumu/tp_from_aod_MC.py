...
#                                                  /DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISummer16DR80Premix-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6_ext1-v1/AODSIM	


##without ext1, works through eos
##    sourcefilesfolder = "/store/mc/RunIISummer16DR80Premix/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/120000/" #2808
...
#    sourcefilesfolder = "/store/mc/RunIISummer16DR80Premix/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6_ext2-v1/110000"  #Ahmad
#    sourcefilesfolder = "/store/mc/RunIISummer16MiniAODv2/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6_ext1-v2/80000"
#    files = subprocess.check_output([ "/afs/cern.ch/project/eos/installation/0.3.15/bin/eos.select", "ls", sourcefilesfolder ])
#    process.source.fileNames = [ sourcefilesfolder+"/"+f for f in files.split()]
...
process.fastFilter = cms.Sequence(process.goodVertexFilter + process.noScraping)  ##default

##process.fastFilter = cms.Sequence(process.goodVertexFilter)
...
#process.TFileService = cms.Service("TFileService", fileName = cms.string("tnpZ_MC_2808.root"))
process.TFileService = cms.Service("TFileService", fileName = cms.string("tnpZ_MC_AODSIM_mupog_single_1209.root"))
#process.TFileService = cms.Service("TFileService", fileName = cms.string("tnpZ_MC_AODSIM_mupog_eosfull_test_1109.root"))
