...
#    sourcefilesfolder = "/store/data/Run2016C/SingleMuon/MINIAOD/03Feb2017-v1/50000/"
#    files = subprocess.check_output([ "/afs/cern.ch/project/eos/installation/0.3.15/bin/eos.select", "ls", sourcefilesfolder ])
#    process.source.fileNames = [ sourcefilesfolder+"/"+f for f in files.split() ]

#    process.GlobalTag.globaltag = cms.string('80X_dataRun2_2016SeptRepro_v5')
    process.GlobalTag.globaltag = cms.string('80X_dataRun2_2016LegacyRepro_v4')
#    process.GlobalTag.globaltag = cms.string('80X_dataRun2_2016LegacyRepro_v3')
...
#process.TFileService = cms.Service("TFileService", fileName = cms.string("tnpZ_Data_RunC_2808.root"))
#process.TFileService = cms.Service("TFileService", fileName = cms.string("tnpZ_Data_RunC_2808_2.root"))

process.TFileService = cms.Service("TFileService", fileName = cms.string("tnpZ_Data_RunB_legacy_mupog_single_1209.root"))
